...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Service.selected'
        db.delete_column('Service', 'selected')


    def backwards(self, orm):
        
        # Adding field 'Service.selected'
        db.add_column('Service', 'selected', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
