...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ranking.creation_date'
        db.add_column('RankingService', 'creation_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Ranking.ranking_date'
        db.add_column('RankingService', 'ranking_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Ranking.validation_date'
        db.add_column('RankingService', 'validation_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Ranking.creation_date'
        db.delete_column('RankingService', 'creation_date')

        # Deleting field 'Ranking.ranking_date'
        db.delete_column('RankingService', 'ranking_date')

        # Deleting field 'Ranking.validation_date'
        db.delete_column('RankingService', 'validation_date')
    ...
    models = {
        ...
        'top5.ranking': {
            ...
            'ranking_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
