...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ranking.pertinency'
        db.alter_column('RankingService', 'pertinency', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Ranking.pertinency'
        db.alter_column('RankingService', 'pertinency', self.gf('django.db.models.fields.IntegerField')())
