...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Ranking.elserank'
        db.delete_column('RankingService', 'elserank')

        # Adding field 'Ranking.pertinency'
        db.add_column('RankingService', 'pertinency', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Ranking.elserank'
        db.add_column('RankingService', 'elserank', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True), keep_default=False)

        # Deleting field 'Ranking.pertinency'
        db.delete_column('RankingService', 'pertinency')
    ...
    models = {
        ...
        'top5.ranking': {
            ...
            'pertinency': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
