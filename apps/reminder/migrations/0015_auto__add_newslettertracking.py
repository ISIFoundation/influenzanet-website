...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NewsletterTracking'
        db.create_table('reminder_newslettertracking', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('newsletter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reminder.NewsLetter'], unique=True)),
            ('tracking', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('first_view', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('reminder', ['NewsletterTracking'])


    def backwards(self, orm):
        
        # Deleting model 'NewsletterTracking'
        db.delete_table('reminder_newslettertracking')
    ...
    models = {
        ...
        'reminder.newslettertracking': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'newsletter': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['reminder.NewsLetter']", 'unique': 'True'}),
