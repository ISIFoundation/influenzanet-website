...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NewsletterTracking.date_sent'
        db.add_column('reminder_newslettertracking', 'date_sent', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NewsletterTracking.date_sent'
        db.delete_column('reminder_newslettertracking', 'date_sent')
