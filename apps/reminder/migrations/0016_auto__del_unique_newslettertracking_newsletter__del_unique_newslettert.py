...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'NewsletterTracking', fields ['user']
        db.delete_unique('reminder_newslettertracking', ['user_id'])

        # Removing unique constraint on 'NewsletterTracking', fields ['newsletter']
        db.delete_unique('reminder_newslettertracking', ['newsletter_id'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'NewsletterTracking', fields ['newsletter']
        db.create_unique('reminder_newslettertracking', ['newsletter_id'])

        # Adding unique constraint on 'NewsletterTracking', fields ['user']
        db.create_unique('reminder_newslettertracking', ['user_id'])
    ...
    models = {
        ...
        'reminder.newslettertracking': {
            'Meta': {'object_name': 'NewsletterTracking'},
            'first_view': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'newsletter': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['reminder.NewsLetter']"}),
            'tracking': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
